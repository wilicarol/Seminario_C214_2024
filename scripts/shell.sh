...
echo "Corpo do e-mail" | mailx -s "Assunto do E-mail" -s smtp=smtp://smtp.example.com:587 -s smtp-use-starttls -s smtp-auth=$1 -s smtp-auth-user=$1 -s smtp-auth-password="fpqi qgxq cdvb cbmi" $1
